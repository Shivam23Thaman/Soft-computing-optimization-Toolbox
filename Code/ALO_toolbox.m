...
% The default name of the objective function is ALO_CostFunction.
% If you have a look at the ALO_CostFunction.m file, you may notice
...
function ALO_CostFunction_Callback(hObject, eventdata, handles)
% hObject    handle to ALO_CostFunction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ALO_CostFunction as text
%        str2double(get(hObject,'String')) returns contents of ALO_CostFunction as a double


% --- Executes during object creation, after setting all properties.
function ALO_CostFunction_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ALO_CostFunction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
fobj=str2func(get(handles.ALO_CostFunction,'String'));
