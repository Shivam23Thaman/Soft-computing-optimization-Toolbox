...
while Time<Max_time+1
    ...
    if Time>2
        line([Time-1 Time], [Convergence_curve(Time-1) Convergence_curve(Time)],'Color','b')
        xlabel('Iteration');
    ...
    set(handles.itertext,'String', ['The current iteration is ', num2str(Time)])
    set(handles.optimumtext,'String', ['The current optimal value is ', num2str(Best_universe_Inflation_rate)])
