function varargout = SCA_toolbox(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @SCA_toolbox_OpeningFcn, ...
                   'gui_OutputFcn',  @SCA_toolbox_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SCA_toolbox is made visible.
function SCA_toolbox_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SCA_toolbox (see VARARGIN)

% Choose default command line output for SCA_toolbox
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes SCA_toolbox wait for user response (see UIRESUME)
...
function varargout = SCA_toolbox_OutputFcn(hObject, eventdata, handles) 
...
[Best_score,Best_pos,cg_curve]=SCA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,handles,value);
