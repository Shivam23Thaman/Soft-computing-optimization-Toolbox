function varargout = MVO_toolbox(varargin)
%%______________________________________________________________________________________%
%  Multi-Verse Optimizer (MVO) toolbox demo version 1.0
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @MVO_toolbox_OpeningFcn, ...
                   'gui_OutputFcn',  @MVO_toolbox_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MVO_toolbox is made visible.
function MVO_toolbox_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MVO_toolbox (see VARARGIN)

% Choose default command line output for MVO_toolbox
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MVO_toolbox wait for user response (see UIRESUME)
...
function varargout = MVO_toolbox_OutputFcn(hObject, eventdata, handles) 
